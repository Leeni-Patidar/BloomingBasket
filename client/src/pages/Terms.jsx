          ...
          <div className="w-full lg:w-2/3">
            <div className="bg-white p-8 px-6 md:p-12 rounded-2xl shadow-2xl">
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">1. Acceptance of Terms</h2>
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">2. Use License</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">3. Product Information</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">4. Pricing and Payment</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">5. Delivery Terms</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">6. Freshness Guarantee</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">7. Cancellation and Refunds</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">8. Privacy Policy</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">9. Limitation of Liability</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">10. Governing Law</h2>
                <p className="text-gray-600 leading-[1.8] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">11. Changes to Terms</h2>
                <p className="text-gray-600 leading-[1] mb-2">
              ...
              <section className="mb-2 pb-4 border-b border-gray-100 last:border-b-0 last:mb-0">
                <h2 className="text-xl md:text-1xl font-semibold mb-2 text-gray-800">12. Contact Information</h2>
                <p className="text-gray-600 leading-[1] mb-2">
