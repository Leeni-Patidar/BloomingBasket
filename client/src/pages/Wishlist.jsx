        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-center">
            <div className="w-full md:w-1/2 text-center">
              ...
              <p className="text-gray-600 mb-4">Save your favorite flowers to your wishlist for easy access later.</p>
              <Link
                to="/shop"
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 py-12 rounded-2xl text-white bg-gradient-to-br from-[#da81a4] to-[#fecfef]">
          ...
          <p className="text-[1.1rem] text-shadow-sm">Your saved favorite flowers ({wishlistItems.length} items)</p>
        </div>
