        ...
        <div className="flex flex-col lg:flex-row items-center justify-center min-h-[calc(100vh-80px)]">
          <div className="w-full lg:w-1/2 text-center lg:text-left  mb-12 lg:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link
                to="/shop"
                className="bg-red-500 border-none  px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 ease-in-out hover:bg-red-600 button-bg:hover hover:shadow-lg"
              >
                Shop Now
              </Link>
              <Link
                to="/customize"
                className="bg-transparent border-2 border-white  px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 ease-in-out hover:bg-white hover:text-red-500 button-bg:hover hover:shadow-lg"
              >
                Customize Bouquet
              </Link>
            </div>
