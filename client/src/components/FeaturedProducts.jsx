              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 ease-in-out h-full hover:-translate-y-1 hover:shadow-lg">
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
                    <button
                      className={`w-10 h-10 rounded-full border-none bg-white text-gray-600 flex items-center justify-center shadow-md transition-all duration-300 ease-in-out hover:bg-[#ba54a9] hover:text-white hover:scale-110 ${isInWishlist(product.id) ? "bg-red-500 text-white" : ""}`}
                ...
                <div className="p-6 text-center">
                  ...
                  <button
                    className="bg-gradient-to-br from-[#ba54a9] to-[#fecfef] border-none text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 ease-in-out w-full hover:-translate-y-0.5 hover:shadow-lg"
